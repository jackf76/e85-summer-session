...
#endif
            VL_FATAL_MT("testbench.sv", 15, "", "Settle region did not converge.");
        }
...
VL_ATTR_COLD void Vtestbench___024root___ctor_var_reset(Vtestbench___024root* vlSelf) {
    ...
    vlSelf->testbench__DOT__sexpected = VL_RAND_RESET_I(1);
    vlSelf->testbench__DOT__coutexpected = VL_RAND_RESET_I(1);
    ...
    vlSelf->testbench__DOT____Vlvbound_h48ca5934__0 = VL_RAND_RESET_I(6);
