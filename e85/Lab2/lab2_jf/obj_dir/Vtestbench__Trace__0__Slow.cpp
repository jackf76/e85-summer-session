...
VL_ATTR_COLD void Vtestbench___024root__trace_init_sub__TOP__0(Vtestbench___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBit(c+8,0,"s",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->declBit(c+9,0,"cout",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1);
    ...
    tracep->declBus(c+10,0,"vectornum",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->declBus(c+11,0,"errors",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
...
VL_ATTR_COLD void Vtestbench___024root__trace_full_0_sub_0(Vtestbench___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullBit(oldp+6,(vlSelf->testbench__DOT__clk));
    bufp->fullBit(oldp+7,(vlSelf->testbench__DOT__reset));
    bufp->fullBit(oldp+8,(vlSelf->testbench__DOT__s));
    bufp->fullBit(oldp+9,(vlSelf->testbench__DOT__cout));
    bufp->fullIData(oldp+10,(vlSelf->testbench__DOT__vectornum),32);
    bufp->fullIData(oldp+11,(vlSelf->testbench__DOT__errors),32);
    bufp->fullIData(oldp+12,(vlSelf->testbench__DOT__unnamedblk1__DOT__i),32);
}
